...
# 작성하는 룰에 맞게 클래스 이름 수정 (KDS249011_04020403_02)
class KDS249011_04020403_02 (RuleUnit):
    ...
    ####  4.2.4.3 회전수용능력
    (2)
    포트받침 및 포트받침과 접하는 구조물들은 탄성패드에 발생하는 최대 구속모멘트($$M_{emax}$$)와 피스톤과 포트벽의 마찰에 의한 모멘트($$M_{\mu max$$})를 고려하여 설계하여야 한다. 이 때 피스톤과 포트벽과의 최대 마찰계수는 0.2를 사용한다.
    """
    # 플로우차트(mermaid)
    flowchart = """
    flowchart TD
