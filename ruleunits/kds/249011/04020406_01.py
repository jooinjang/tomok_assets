...
# 작성하는 룰에 맞게 클래스 이름 수정 (KDS249011_04020406_01)
class KDS249011_04020406_01 (RuleUnit):

    # 아래 클래스 멤버 변수에 할당되는 값들을 작성하는 룰에 맞게 수정
    priority = 1   # 건설기준 우선순위
    author = 'Seohyun Jin'  # 작성자명
    ref_code = 'KDS 24 90 11 4.2.4.6 (1)' # 건설기준문서
    ...
    ####  4.2.4.6 탄성패드 설계
    (1)
    탄성패드의 최소두께는 다음의 식으로 구하며, $$\frac{d}{15}$$ 보다 작지 않아야 한다.
    $$t_{min} = 3.33\times \alpha _{dmax}\times d$$&#160;&#160;&#160;&#160;&#160;(4.2-24)

    여기서, $$\alpha _{dmax}$$ = 설계최대 회전각(rad)
    d = 탄성패드의 직경(mm)
