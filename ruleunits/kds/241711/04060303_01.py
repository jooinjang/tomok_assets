...
# 작성하는 룰에 맞게 클래스 이름 수정 (KDS241711_04060303_01)
...
my_RuleUnit = KDS241711_04060303_01()
...
Rule_Review_Result = my_RuleUnit.axial_reinforcement_cross_sectional_area(fIaxrcsa,fItcsaco)
