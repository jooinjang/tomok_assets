...
# 작성하는 룰에 맞게 클래스 이름 수정 (KDS241421_04010201_06)
class KDS241421_04010201_06 (RuleUnit):
    ...
    # 건설기준문서내용(text)
    content = """
    \n (6) 작용 계수하중에 의한 단면의 전단력 $V_{u}$가 콘크리트 설계전단강도 $V_{cd}$보다 큰 구간에는 4.1.2.3의 규정에 따라 충분한 전단철근을 배치하여 $V_{u} \\leq V_{d}$가 되도록 하여야 한다.
    """
    # 플로우차트(mermaid)
    flowchart = """
    flowchart TD
